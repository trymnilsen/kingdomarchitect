...
describe("timeline builder", () => {
    describe("basic recipe structure", () => {
    ...
    describe("mirror toggles", () => {
        ...
        it("cursor resets to 0 after each mirror()", () => {
            const recipe = timeline("test")
                ...
                .at(20)
                .mirror()
                .mirror() // no at(), so it should use 0 (reset after previous mirror)
                .build();
    ...
    describe("part track operations", () => {
    ...
    describe("anchor track operations", () => {
