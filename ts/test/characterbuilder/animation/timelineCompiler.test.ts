...
describe("compileTimeline", () => {
    describe("base frame replication", () => {
    ...
    describe("anchor operations", () => {
        it("anchor offset shifts x and y, preserves z", () => {
            ...
            const recipe = makeRecipe({
                ...
                anchorTracks: {
                    LeftHand: [
                        { type: "offset", start: 1, end: 2, x: 1, y: -1 },
                    ],
                },
            });
    ...
    describe("recipe base composition", () => {
    ...
    describe("addPixels operation", () => {
        ...
        it("two addPixels ops on the same frame both append", () => {
            const sources = [makeSourceAnimation("source_walk", 1)];
            const recipe = makeRecipe({
                duration: 2,
                tracks: {
