...
export const spriteDefinitions: Record<string, number[]> = {
    ...
    "spinning_coin": [16,16,64,66,4],
    "dead_tree": [16,16,74,48],
    "desert_ruin_large": [16,16,88,16],
    "desert_ruin_two_floor": [16,16,88,32],
    "desert_ruin_two_floor_vines": [16,16,89,0],
    "dweller": [16,16,90,48],
    "fancy_wood_bg": [32,32,0,102],
    "farm_1": [16,16,106,0],
    "farm_2": [16,16,106,16],
    "farm_3": [16,16,104,32],
    "farm_4": [16,16,106,48],
    "worker": [16,16,32,102],
    "stone_brazier": [16,16,120,32,8],
    "torches": [16,16,32,118,8],
    "lamp_post": [16,16,48,102],
    "gate_horizontal": [20,20,122,0],
    "gate_horizontal_closed": [20,20,142,0],
    "gate_horizontal_preview": [20,20,162,0],
    "gate_vertical": [20,20,182,0],
    "goblin_house": [16,16,64,102],
    "goblin": [16,16,80,102],
    "wooden_house_scaffold": [16,16,96,102],
    "wooden_house": [16,16,112,102],
    "interior_stool": [16,16,122,48],
    "interior_table": [16,16,202,0],
    "interior_stone_wall_right_bottom": [16,16,202,16],
    "interior_stone_wall_top_bottom": [16,16,218,0],
    "interior_stone_wall_right_top": [16,16,218,16],
    "interior_stone_wall_right_left": [16,16,234,0],
    "interior_stone_wall_left_top": [16,16,234,16],
    "interior_stone_wall_left_bottom": [16,16,128,64],
    "interior_wood_wall_right_bottom": [16,16,138,48],
    "interior_wood_wall_top_bottom": [16,16,128,80],
    "interior_wood_wall_right_top": [16,16,128,96],
    "interior_wood_wall_right_left": [16,16,144,64],
    "interior_wood_wall_left_top": [16,16,154,48],
    "interior_wood_wall_left_bottom": [16,16,144,80],
    "character_sword": [8,16,248,32],
    "wizard_hat": [16,16,144,96],
    "wayshrine": [16,16,0,134,8],
    "iron_brazier": [16,16,128,134,8],
    "iron_brazier_dark": [16,16,160,64],
    "glowmoss_lantern": [16,16,0,150,8],
    "pyre": [16,16,128,150,8],
    "pyre_dark": [16,16,170,48],
    "wayshrine_scaffold": [16,16,160,80],
    "iron_brazier_scaffold": [16,16,160,96],
    "glowmoss_lantern_scaffold": [16,16,160,112],
    "pyre_scaffold": [16,16,176,64],
    "mage": [16,16,186,48],
    "building_baker": [16,16,176,80],
    "building_bowyer": [16,16,176,96],
    "building_enchanter": [16,16,176,112],
    "empty_sprite": [16,16,202,48],
    "nature_grass_leaves": [9,6,128,112],
    "nature_mushroom": [8,7,122,20],
    "nature_mushroom2": [8,7,130,20],
    "nature_treestub": [14,11,138,20],
    "nature_berrybush": [13,10,152,20],
    "nature_berrybush_wo": [13,10,165,20],
    "paladin": [16,16,0,166,5],
    "pine_tree": [16,16,80,166],
    "pine_tree_winter": [16,16,96,166],
    "sword_iron": [16,16,112,166],
    "sword_emerald": [16,16,128,166],
    "sword_ruby": [16,16,144,166],
    "building_mill": [16,16,160,166],
    "building_quarry": [16,16,176,166],
    "rocks": [16,16,192,166],
    "ruins": [16,16,208,166],
    "ruins_wines": [16,16,224,166],
    "stockpile": [16,16,240,166],
    "stone": [16,16,218,48],
    "stone2": [16,16,234,48],
    "stone3": [16,16,192,64],
    "winter_stone": [16,16,208,64],
    "winter_stone2": [16,16,224,64],
    "winter_stone3": [16,16,240,64],
    "plains_stone": [16,16,192,80],
    "plains_stone2": [16,16,192,96],
    "plains_stone3": [16,16,192,112],
    "stone_wood_walls": [16,16,208,80],
    "sun_icon": [16,16,224,80],
    "sunrise_icon": [16,16,240,80],
    "moon_icon": [16,16,208,96],
    "knight": [16,16,0,182,5],
    "knight_up": [16,16,80,182,5],
    "knight_right": [16,16,160,182,5],
    "knight_left": [16,16,0,198,5],
    "knight_idle_down": [16,16,224,96,2],
    "knight_idle_up": [16,16,80,198,2],
    "knight_idle_right": [16,16,112,198,2],
    "knight_idle_left": [16,16,144,198,2],
    "building_tavern": [16,16,240,182],
    "tent": [16,16,176,198],
    "tent_flag": [16,16,192,198],
    "building_tombstone": [16,16,208,198],
    "tree_1": [16,16,240,198],
    "tree_2": [16,16,208,112],
    "tree_3": [16,16,224,112],
    "tumbleweed_1": [16,16,240,112],
    "tumbleweed_2": [16,16,0,214],
    "warehouse": [16,16,16,214],
    "well": [16,16,32,214],
    "building_blacksmith": [16,16,48,214],
    "building_workshop": [16,16,64,214],
    "archer_skill": [32,32,0,230],
    "bag_of_glitter": [32,32,32,230],
    "Biome_Icons": [120,152,256,0],
    "blue_book": [32,32,64,230],
    "bonfire": [16,16,80,214],
    "book_border": [40,40,96,214],
    "book_grid_item": [32,32,136,214],
    "book_grid_item_focused": [32,32,168,214],
    "book_grid_item_gray": [32,32,200,214],
    "book_grid_item_gray_focused": [32,32,232,214],
    "book_left": [46,50,256,152],
    "book_right": [46,50,264,202],
    "book_tab": [40,40,302,152],
    "building_forrester": [16,16,136,246],
    "building_statue": [16,16,152,246],
    "building_tower": [16,16,168,246],
    "card": [40,48,310,192],
    "carpenter": [16,16,184,246],
    "charcoal_resource": [32,32,342,152],
    "cursor": [32,32,0,262],
    "cursor_bw": [32,32,32,262],
    "cursor_red": [32,32,64,262],
    "fancy_wood_background": [48,48,200,246],
    "fence": [16,16,248,246],
    "gem_resource": [32,32,96,262],
    "generic_skill": [32,32,248,262],
    "gold_coins": [32,32,128,262],
    "health_potion": [32,32,160,262],
    "health_potion_shadow": [32,32,280,252],
    "interior_door": [16,16,350,184],
    "interior_floor": [16,16,350,200],
    "stone_walls_cracks": [128,64,0,294],
    "iron_bars": [32,32,312,240],
    "iron_ore_resource": [32,32,344,240],
    "brown_hat": [128,128,0,358],
    "short_hair_blonde": [128,128,128,294],
    "weapons": [32,8,96,254],
    "white_beard": [128,128,376,0],
    "light": [16,16,350,216],
    "mana_potion": [32,32,366,184],
    "resource_corn": [32,32,374,152],
    "scroll": [32,32,128,422],
    "stone_resource": [32,32,128,454],
    "stone_slate_background": [48,48,160,422],
    "stone_slate_background_2x": [48,48,208,422],
    "stone_slate_border": [16,16,160,470],
    "stone_slate_border_selected": [16,16,176,470],
    "stone_slate_button_2x": [48,48,406,128],
    "stone_slate_dark_background_2x": [48,48,454,128],
    "stone_wood_walls_bottom": [20,20,366,216],
    "stone_wood_walls_br": [20,20,376,128],
    "stone_wood_walls_horizontal": [20,20,406,176],
    "stone_wood_walls_lb": [20,20,426,176],
    "stone_wood_walls_lbr": [20,20,446,176],
    "stone_wood_walls_left": [20,20,466,176],
    "stone_wood_walls_lu": [20,20,398,196],
    "stone_wood_walls_lub": [20,20,418,196],
    "stone_wood_walls_lur": [20,20,438,196],
    "stone_wood_walls_lurb": [20,20,458,196],
    "stone_wood_walls_right": [20,20,478,196],
    "stone_wood_walls_scaffold": [20,20,386,216],
    "stone_wood_walls_single": [20,20,406,216],
    "stone_wood_walls_ubr": [20,20,426,216],
    "stone_wood_walls_up": [20,20,446,216],
    "stone_wood_walls_ur": [20,20,466,216],
    "stone_wood_walls_vertical": [20,20,376,236],
    "swipe_effect": [40,40,396,236],
    "sword_skill": [32,32,436,236],
    "sword_skill_shadow": [32,32,468,236],
    "times": [16,16,192,470],
    "training_dummy": [16,16,208,470],
    "wizard_hat_skill": [32,32,436,268],
    "wood_resource": [32,32,468,268],
    "worker_skill": [32,32,312,272]
};
export const bins = [
  {
    "name": "0",
