...
export const spriteDefinitions: Record<string, number[]> = {
    ...
    "building_brewery": [16,16,112,64],
    "building_smokehouse": [16,16,127,48],
    "building_hunters_lodge": [16,16,128,32],
    "building_fishers_hut": [16,16,144,32],
    "building_granary": [16,16,143,48],
    "building_coop": [16,16,123,80],
    "building_pigsty": [16,16,128,64],
    "building_goat_pen": [16,16,144,64],
    "building_orchard": [16,16,139,80],
    "building_apiary": [16,16,128,96],
    "gate_horizontal": [20,20,128,112],
    "gate_horizontal_closed": [20,20,128,132],
    "gate_horizontal_preview": [20,20,128,152],
    "gate_vertical": [20,20,160,0],
    "goblin_house": [16,16,159,48],
    "goblin": [16,16,144,96],
    "wooden_house_scaffold": [16,16,155,80],
    "wooden_house": [16,16,160,64],
    "interior_stool": [16,16,160,20],
    "interior_table": [16,16,160,96],
    "interior_stone_wall_right_bottom": [16,16,148,112],
    "interior_stone_wall_top_bottom": [16,16,164,112],
    "interior_stone_wall_right_top": [16,16,148,128],
    "interior_stone_wall_right_left": [16,16,164,128],
    "interior_stone_wall_left_top": [16,16,148,144],
    "interior_stone_wall_left_bottom": [16,16,164,144],
    "interior_wood_wall_right_bottom": [16,16,0,175],
    "interior_wood_wall_top_bottom": [16,16,16,175],
    "interior_wood_wall_right_top": [16,16,32,175],
    "interior_wood_wall_right_left": [16,16,48,175],
    "interior_wood_wall_left_top": [16,16,64,175],
    "interior_wood_wall_left_bottom": [16,16,80,175],
    "character_sword": [8,16,171,80],
    "wizard_hat": [16,16,96,175],
    "wayshrine": [16,16,176,96,8],
    "iron_brazier": [16,16,112,175,8],
    "iron_brazier_dark": [16,16,175,36],
    "glowmoss_lantern": [16,16,180,112,8],
    "pyre": [16,16,176,20,8],
    "pyre_dark": [16,16,180,0],
    "wayshrine_scaffold": [16,16,196,0],
    "iron_brazier_scaffold": [16,16,212,0],
    "glowmoss_lantern_scaffold": [16,16,228,0],
    "pyre_scaffold": [16,16,244,0],
    "mage": [16,16,260,0],
    "building_baker": [16,16,276,0],
    "building_bowyer": [16,16,292,0],
    "building_enchanter": [16,16,176,52],
    "empty_sprite": [16,16,191,36],
    "nature_grass_leaves": [9,6,96,80],
    "nature_mushroom": [8,7,88,71],
    "nature_mushroom2": [8,7,77,101],
    "nature_treestub": [14,11,160,36],
    "nature_berrybush": [13,10,176,68],
    "nature_berrybush_wo": [13,10,107,96],
    "paladin": [16,16,179,78,5],
    "pine_tree": [16,16,192,52],
    "pine_tree_winter": [16,16,207,36],
    "sword_iron": [16,16,208,52],
    "sword_emerald": [16,16,223,36],
    "sword_ruby": [16,16,224,52],
    "building_mill": [16,16,239,36],
    "building_quarry": [16,16,240,52],
    "rocks": [16,16,255,36],
    "ruins": [16,16,256,52],
    "ruins_wines": [16,16,271,36],
    "stockpile": [16,16,287,36],
    "stone": [16,16,259,68],
    "stone2": [16,16,272,52],
    "stone3": [16,16,288,52],
    "winter_stone": [16,16,275,68],
    "winter_stone2": [16,16,291,68],
    "winter_stone3": [16,16,180,128],
    "plains_stone": [16,16,180,144],
    "plains_stone2": [16,16,196,128],
    "plains_stone3": [16,16,196,144],
    "stone_wood_walls": [16,16,212,128],
    "sun_icon": [16,16,212,144],
    "sunrise_icon": [16,16,228,128],
    "moon_icon": [16,16,228,144],
    ...
    "tent": [16,16,224,207],
    "tent_flag": [16,16,240,160],
    "building_tombstone": [16,16,244,128],
    "tree_1": [16,16,240,176],
    "tree_2": [16,16,240,192],
    "tree_3": [16,16,260,128],
    "tumbleweed_1": [16,16,276,128],
    "tumbleweed_2": [16,16,292,128],
    "warehouse": [16,16,260,144],
    "well": [16,16,276,144],
    "building_blacksmith": [16,16,292,144],
    "building_workshop": [16,16,256,160],
    "archer_skill": [32,32,272,160],
    "bag_of_glitter": [32,32,0,223],
    "Biome_Icons": [120,152,0,255],
    "blue_book": [32,32,32,223],
    "bonfire": [16,16,256,176],
    "book_border": [40,40,256,192],
    "book_grid_item": [32,32,64,223],
    "book_grid_item_focused": [32,32,96,223],
    "book_grid_item_gray": [32,32,128,223],
    "book_grid_item_gray_focused": [32,32,160,223],
    "book_left": [46,50,192,223],
    "book_right": [46,50,238,232],
    "book_tab": [40,40,120,255],
    "building_forrester": [16,16,240,208],
    "building_statue": [16,16,284,232],
    "building_tower": [16,16,284,248],
    "card": [40,48,160,273],
    "carpenter": [16,16,160,255],
    "charcoal_resource": [32,32,200,273],
    "cursor": [32,32,120,295],
    "cursor_bw": [32,32,232,282],
    "cursor_red": [32,32,200,305],
    "fancy_wood_background": [48,48,152,321],
    "fence": [16,16,176,255],
    "gem_resource": [32,32,120,327],
    "generic_skill": [32,32,120,359],
    "gold_coins": [32,32,152,369],
    "health_potion": [32,32,184,369],
    "health_potion_shadow": [32,32,200,337],
    "interior_door": [16,16,120,391],
    "interior_floor": [16,16,136,391],
    "stone_walls_cracks": [128,64,308,0],
    "iron_bars": [32,32,216,369],
    "iron_ore_resource": [32,32,296,192],
    "brown_hat": [128,128,308,64],
    "short_hair_blonde": [128,128,300,224],
    "weapons": [32,8,189,68],
    "white_beard": [128,128,0,407],
    "light": [16,16,284,264],
    "mana_potion": [32,32,328,192],
    "resource_corn": [32,32,360,192],
    "scroll": [32,32,392,192],
    "stone_resource": [32,32,264,282],
    "stone_slate_background": [48,48,248,314],
    "stone_slate_background_2x": [48,48,128,407],
    "stone_slate_border": [16,16,232,314],
    "stone_slate_border_selected": [16,16,232,330],
    "stone_slate_button_2x": [48,48,128,455],
    "stone_slate_dark_background_2x": [48,48,176,401],
    "stone_wood_walls_bottom": [20,20,128,503],
    "stone_wood_walls_br": [20,20,148,503],
    "stone_wood_walls_horizontal": [20,20,168,503],
    "stone_wood_walls_lb": [20,20,176,449],
    "stone_wood_walls_lbr": [20,20,176,469],
    "stone_wood_walls_left": [20,20,188,489],
    "stone_wood_walls_lu": [20,20,188,509],
    "stone_wood_walls_lub": [20,20,196,449],
    "stone_wood_walls_lur": [20,20,196,469],
    "stone_wood_walls_lurb": [20,20,208,489],
    "stone_wood_walls_right": [20,20,208,509],
    "stone_wood_walls_scaffold": [20,20,216,449],
    "stone_wood_walls_single": [20,20,216,469],
    "stone_wood_walls_ubr": [20,20,228,489],
    "stone_wood_walls_up": [20,20,228,509],
    "stone_wood_walls_ur": [20,20,224,401],
    "stone_wood_walls_vertical": [20,20,224,421],
    "swipe_effect": [40,40,236,441],
    "sword_skill": [32,32,244,401],
    "sword_skill_shadow": [32,32,248,362],
    "times": [16,16,232,346],
    "training_dummy": [16,16,248,481],
    "wizard_hat_skill": [32,32,248,497],
    "wood_resource": [32,32,276,394],
    "worker_skill": [32,32,280,362]
};
export const bins = [
  {
    "name": "0",
...
export const spriteRefs = {
  ...
  "building_brewery": {
    "bin": "0",
    "spriteId": "building_brewery"
  },
  "building_smokehouse": {
    "bin": "0",
    "spriteId": "building_smokehouse"
  },
  "building_hunters_lodge": {
    "bin": "0",
    "spriteId": "building_hunters_lodge"
  },
  "building_fishers_hut": {
    "bin": "0",
    "spriteId": "building_fishers_hut"
  },
  "building_granary": {
    "bin": "0",
    "spriteId": "building_granary"
  },
  "building_coop": {
    "bin": "0",
    "spriteId": "building_coop"
  },
  "building_pigsty": {
    "bin": "0",
    "spriteId": "building_pigsty"
  },
  "building_goat_pen": {
    "bin": "0",
    "spriteId": "building_goat_pen"
  },
  "building_orchard": {
    "bin": "0",
    "spriteId": "building_orchard"
  },
  "building_apiary": {
    "bin": "0",
    "spriteId": "building_apiary"
  },
  "gate_horizontal": {
    "bin": "0",
