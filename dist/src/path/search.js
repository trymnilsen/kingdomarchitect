...
export class PathSearch {
    ...
    search(from, to, allowPartialPaths, weightModifier) {
        ...
        while(openHeap.size > 0){
            ...
            for(let i = 0, il = neighbors.length; i < il; ++i){
                ...
                if (!beenVisited || gScore < neighbor.g) {
                    ...
                    const neighborCloserThanClosest = neighbor.h < closestNode.h;
                    const neighborIsCheaper = neighbor.h === closestNode.h && neighbor.g < closestNode.g;
