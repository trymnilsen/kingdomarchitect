 ...
 */ export function configureText(renderItem, context) {
...
export function textRenderer(renderItem, context) {
    configureText(renderItem, context);
    context.fillText(renderItem.text, Math.floor(renderItem.x), Math.floor(renderItem.y));
}
