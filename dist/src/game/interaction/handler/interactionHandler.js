 ...
 */ export class InteractionHandler {
    ...
    onInput(inputAction) {
        const inputHandled = this.history.state.onInput(inputAction, this.interactionStateChanger);
        if (!inputHandled && inputAction.action == InputActionType.BACK_PRESS && !this.interactionStateChanger.hasOperations) {
    ...
    constructor(world, camera, assets, time){
        _define_property(this, "camera", void 0);
        _define_property(this, "world", void 0);
        _define_property(this, "interactionStateChanger", void 0);
