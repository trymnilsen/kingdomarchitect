 ...
 */ export function createGraphFromNodes(rootEntity) {
...
export function createLazyGraphFromRootNode(node) {
...
function getWeightAtPoint(point, rootEntity, groundComponent) {
    let weight = 1000;
