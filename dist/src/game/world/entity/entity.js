...
import { addPoint, subtractPoint, zeroPoint } from "../../../common/point.js";
export class Entity {
    /**
     ...
     */ set worldPosition(position) {
        ...
        if (!!this.parent) {
            this._localPosition = subtractPoint(position, this.parent.worldPosition);
        } else {
            this._localPosition = position;
        }
        this.updateTransform();
     ...
     */ addChild(entity, index = null) {
        if (entity === this) {
            throw new InvalidArgumentError("Cannot add self as a child");
        }
        if (!!entity.parent) {
            throw new InvalidArgumentError("Entity is already added to another entity");
        }
        if (index != null) {
     ...
     */ addComponent(entityComponent) {
        const componentName = Object.getPrototypeOf(entityComponent).constructor.name;
        if (!!this._componentsMap[componentName]) {
            throw new InvalidArgumentError(`Component already added ${entityComponent}`);
        }
     ...
     */ getComponent(filterType) {
        const componentId = filterType.name;
        const component = this._componentsMap[componentId];
     ...
     * @see getComponent
     * @param filterType the type of the component to get
     */ getAncestorComponent(filterType) {
        let entityToLookOn = this;
     ...
     */ onDraw(renderContext) {
        if (this._components.length > 0) {
            ...
            const screenPosition = renderContext.camera.tileSpaceToScreenSpace(this._worldPosition);
     ...
     */ updateTransform() {
        if (!!this.parent) {
            ...
            this._worldPosition = addPoint(this.parent.worldPosition, this._localPosition);
        } else {
    ...
    constructor(id){
        ...
        _define_property(this, "_isRoot", void 0);
        _define_property(this, "_parent", void 0);
        _define_property(this, "_children", void 0);
        _define_property(this, "_localPosition", void 0);
        _define_property(this, "_worldPosition", void 0);
        _define_property(this, "_componentEvents", void 0);
        _define_property(this, "_componentsMap", void 0);
        _define_property(this, "_components", void 0);
        this.id = id;
        this._isRoot = false;
        this._children = [];
        this._localPosition = zeroPoint();
        this._worldPosition = zeroPoint();
        this._componentEvents = new TypedEvent();
        this._componentsMap = {};
        this._components = [];
    }
}
